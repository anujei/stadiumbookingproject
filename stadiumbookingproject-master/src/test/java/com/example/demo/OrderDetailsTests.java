...
public class OrderDetailsTests {
	...
	{
		when(orderDetailDao.findAll()).thenReturn(List.of(new OrderDetail(1, 100, 200, "COD", "Active")));
	...
	{
		OrderDetail orderDetail  = new OrderDetail(1, 100, 200, "COD", "Active");
	...
	{
		OrderDetail orderDetail  = new OrderDetail(1, 10, 500, "Online", "Active");
		when(orderDetailDao.save(orderDetail)).thenReturn(orderDetail);
